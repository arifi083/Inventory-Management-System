          ...
          <div class="card-body p-0">
            ...
            <form class="user" @submit.prevent="login">
              ...
              <div class="form-group">
                <input type="email" class="form-control" v-model="form.email" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address">
   ...
   methods:{
     login(){
       ...
       .catch(
          Toast.fire({
            icon: 'warning',
            title: 'Invaild Email and Passdword'
          })
       )
     }
   }
